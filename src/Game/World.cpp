...
<<<<<<< HEAD
=======
    NWorld::registerActor<Entity>("Entity");
    NWorld::registerActor<Building>("Building");
    NWorld::registerActor<Unit>("Unit");
    NWorld::registerActor<Map>("Map");
    NWorld::registerActor<Forest>("Forest");
    NWorld::registerActor<Hall>("Hall");
